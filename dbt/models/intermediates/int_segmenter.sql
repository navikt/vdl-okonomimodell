...
rename_columns as ( 
    select
        ...
        cast("'0_intern_ksted'"[0][1] as varchar(2000)) as kostnadssted_totalniva_beskrivelse,
        -- Oppgaver
        ...
        cast("'0_intern_produkt'"[0][1] as varchar(2000)) as produkt_totalniva_beskrivelse,
        -- Statsregnskapskonti
        ...
        cast("'1_intern_statskonto'"[0][0] as varchar(200)) as statsregnskapskonto_totalniva,
        cast("'1_intern_statskonto'"[0][1] as varchar(2000))  as statsregnskapskonto_totalniva_beskrivelse
    from pivot_table
), 
